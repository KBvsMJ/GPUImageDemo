...
@interface JBCroppableImageView ()

@property (nonatomic, strong, readwrite) JBCroppableLayer *pointsView;
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.pointsView = [[JBCroppableLayer alloc] initWithImageView:self];
